...
from SecondaryOperations import (HighContrast, LowContrast, Blur, Sharpen, UniformNoise, TV_Chambolle,  HistogramEqualization, Skew, ElasticDistortion, Resize) 
...
def addtl_augs(strength, img_in, lbl_in, i= 0):
    ...
    if factor(strength, i) ==0:
        ...
        if i == 0:
            ...
            img_out, lbl_out = addtl_choices[i](img_in, factor(strength, i)), lbl_in
        else:
            if i ==8:
                img1 = img_in
            else:
            ...
            if i<12:
                img_out, lbl_out = addtl_choices[i][1](img1, lbl_in, factor(strength, 8))
            else:
                img_out,lbl_out = addtl_choices[i][1](img1, lbl_in, factor(strength, 9))
