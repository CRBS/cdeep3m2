...
def MultiResUnet3D(height, width, z, n_channels):
    ...
    pool1 = MaxPooling3D(pool_size=(2, 2, 1))(mresblock1)
    mresblock1 = ResPath(32, 4, mresblock1) 

    mresblock2 = MultiResBlock(32*2, pool1)
    pool2 = MaxPooling3D(pool_size=(2, 2, 1))(mresblock2)
    mresblock2 = ResPath(32*2, 3,mresblock2) 

    mresblock3 = MultiResBlock(32*4, pool2)
    pool3 = MaxPooling3D(pool_size=(2, 2, 1))(mresblock3)
    mresblock3 = ResPath(32*4, 2,mresblock3) 

    mresblock4 = MultiResBlock(32*8, pool3)
    pool4 = MaxPooling3D(pool_size=(2, 2, 1))(mresblock4)
    mresblock4 = ResPath(32*8, 1,mresblock4) 

    mresblock5 = MultiResBlock(32*16, pool4)

    up6 = concatenate([Conv3DTranspose(32*8, (2, 2, 2), strides=(2, 2, 1), padding='same')(mresblock5), mresblock4], axis=4)
    mresblock6 = MultiResBlock(32*8,up6)
    
    up7 = concatenate([Conv3DTranspose(32*4, (2, 2, 2), strides=(2, 2, 1), padding='same')(mresblock6), mresblock3], axis=4)
    mresblock7 = MultiResBlock(32*4,up7)

    up8 = concatenate([Conv3DTranspose(32*2, (2, 2, 2), strides=(2, 2, 1), padding='same')(mresblock7), mresblock2], axis=4)
    mresblock8 = MultiResBlock(32*2,up8)

    up9 = concatenate([Conv3DTranspose(32, (2, 2, 2), strides=(2, 2, 1), padding='same')(mresblock8), mresblock1], axis=4)
