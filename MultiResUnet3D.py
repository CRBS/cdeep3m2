...
def MultiResUnet3D(height, width, z, n_channels):
    ...
    up6 = concatenate([Conv3DTranspose(32 * 8, (2, 2, 2), strides=(2,
                                                                   2, 1), padding='same')(mresblock5), mresblock4], axis=4)
    mresblock6 = MultiResBlock(32 * 8, up6)

    up7 = concatenate([Conv3DTranspose(32 * 4, (2, 2, 2), strides=(2,
                                                                   2, 1), padding='same')(mresblock6), mresblock3], axis=4)
    mresblock7 = MultiResBlock(32 * 4, up7)

    up8 = concatenate([Conv3DTranspose(32 * 2, (2, 2, 2), strides=(2,
                                                                   2, 1), padding='same')(mresblock7), mresblock2], axis=4)
    mresblock8 = MultiResBlock(32 * 2, up8)

    up9 = concatenate([Conv3DTranspose(32, (2, 2, 2), strides=(
        2, 2, 1), padding='same')(mresblock8), mresblock1], axis=4)
